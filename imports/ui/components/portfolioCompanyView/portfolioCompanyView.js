...
import template from './portfolioCompanyView.html';
...
const name = 'portfolioCompanyView';
...
export default angular.module(name, [
  ...
  template,
  controllerAs: name,
  controller: PortfolioCompanyView
}).config(config);

function config($stateProvider) {
  'ngInject';
  $stateProvider
    .state('profile.portfolio.company', {
      url: '/company',
      title: 'Add Company',
      template: '<portfolio-company-view></portfolio-company-view>'
    });
}
